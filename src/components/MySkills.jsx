...
const MySkills = () => {
  return (
    <div id='skill' className="p-4 md:pl-28 md:pr-28">
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 mb-24'>
        ...
        <div className='shadow-2xl mb-7'>
          <img className='w-[400px] flex justify-center pt-7' src={css} alt="" />
        </div>
        <div className='shadow-2xl mb-7 flex justify-center p-10'>
